...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./SoMaDrIn.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("SO", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S SoMaDrIn -X kill
screen -S SoMaDrIn ./SoMaDrIn
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SoMaDrInTEAM/Files_SoMaDrIn/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1573309498,1355955429,1033028167}   
function SudoBot(msg)  
local SoMaDrIn = false  
...
local SoMaDrIn_Msg = ''  
if msgs < 100 then 
SoMaDrIn_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
SoMaDrIn_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
SoMaDrIn_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
SoMaDrIn_Msg = 'متفاعل' 
elseif msgs < 1200 then 
SoMaDrIn_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
SoMaDrIn_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
SoMaDrIn_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
SoMaDrIn_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
SoMaDrIn_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
SoMaDrIn_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
SoMaDrIn_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
SoMaDrIn_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
SoMaDrIn_Msg = 'رب التفاعل'  
end 
return SoMaDrIn_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceSoMaDrIn(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,SoMaDrIn_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf SoMaDrIn.lua')
os.execute('wget https://raw.githubusercontent.com/SoMaDrInTEAM/SoMaDrIn/main/SoMaDrIn.lua')
send(msg.chat_id_, msg.id_,' ✞تم تحديث السورس \n ✞لديك اخر اصدار لسورس سومادرين\n ✞الاصدار » { 1.3v}')
dofile('SoMaDrIn.lua')  
end
if text == 'الاصدار ❃' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✞اصدار سورس سومادرين \n ✞الاصدار »{ 1.3v}')
end
...
send(msg.chat_id_, msg.id_,'✞ عدد الكروبات الان » { '..#group..' }'..SoMaDrInk..''..SoMaDrIn..'\n✞ الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ✞العضو » ['..result.title_..'](t.me/'..(username or 'XvXvJ')..')'
status  = '\n ✞تم ترقيته مطور'
...
usertext = '\n ✞العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'XvXvJ')..')'
status  = '\n ✞تم ترقيته مطور'
...
local SoMaDrIn1_Msg = database:get(bot_id.."SoMaDrIn1:Add:Filter:Rp2"..text..msg.chat_id_)   
if SoMaDrIn1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✞العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XvXvJ')..') \n ✞'..SoMaDrIn1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if SoMaDrIn_Msg and not Special(msg) then  
local SoMaDrIn_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if SoMaDrIn_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✞العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✞["..SoMaDrIn_Msg.."] \n")
else
send(msg.chat_id_,0," ✞العضو : {["..data.first_name_.."](T.ME/XvXvJ)}\n ✞["..SoMaDrIn_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✞عذرا » {["..data.first_name_.."](T.ME/XvXvJ)}\n ✞عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
ᯓ SoMaDrIn TEAM  •
 ✞
ᯓ SoMaDrIn TEAM  •
 ✞↬[Channel SoMaDrIn](t.me/XvXvJ) 
ᯓ SoMaDrIn TEAM  •
 ✞↬[Information](t.me/XvXvJ)
ᯓ SoMaDrIn TEAM  •
 ✞↬[DEVELOPER](t.me/IPIPIPl)
ᯓ SoMaDrIn TEAM  •
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✞بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XvXvJ')..') \n ✞تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✞بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'XvXvJ')..') \n ✞تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✞لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'XvXvJ')..')'
status  = '\n ✞تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✞العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✞العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'XvXvJ')..')'
...
database:set(bot_id.."SoMaDrIn1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."SoMaDrIn1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ✞ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."SoMaDrIn1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."SoMaDrIn1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."SoMaDrIn1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."SoMaDrIn1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ✞تم منع الكلمه مع التحذير")  
database:del(bot_id.."SoMaDrIn1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."SoMaDrIn1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."SoMaDrIn1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."SoMaDrIn1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ✞ارسل الكلمه الان")  
database:set(bot_id.."SoMaDrIn1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."SoMaDrIn1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."SoMaDrIn1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SoMaDrIn1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."SoMaDrIn1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."SoMaDrIn1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."SoMaDrIn1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SoMaDrIn1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."SoMaDrIn1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ✞قائمة المنع \nᯓ SoMaDrIn TEAM  •\n"
for k,v in pairs(list) do  
local SoMaDrIn_Msg = database:get(bot_id.."SoMaDrIn1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..SoMaDrIn_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✞العضو » ['..result.title_..'](t.me/'..(text1[3] or 'XvXvJ')..')'..'\n ✞تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سومادرين').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سومادرين')
local SoMaDrIn_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..SoMaDrIn_Msg[math.random(#SoMaDrIn_Msg)]..']') 
return false
end
...
},function(ta,SoMaDrIn)
local t = "\nツ قائمة الاعضاء \nᯓ SoMaDrIn TEAM  •\n"
x = 0
local list = SoMaDrIn.members_
for k, v in pairs(list) do
x = x + 1
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سومادرين').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'XvXvJ')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
SoMaDrIndx(msg.chat_id_, msg.id_, ' ✞ايدي المجموعة » ( '..msg.chat_id_..' )\n ✞عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ✞عدد المحظورين » ( *'..data.kicked_count_..' )*\n ✞عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ᯓ SoMaDNIN TEAM  •❃∫○ٴ\n✞✞ .[𝘉𝘖𝘠𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/XvXvJ)➢ ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سومادرين')
...
SoMaDrIn = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(SoMaDrIn)
...
--------------------------------------------------------------------------------------------------------------
SourceSoMaDrIn(data.message_,data)
...
------------------------------------------------------------------------
local SoMaDrInAbot = database:get(bot_id.."SoMaDrIn1:Add:Filter:Rp2"..text..result.chat_id_)   
if SoMaDrInAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✞العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✞["..SoMaDrInAbot.."] \n") 
else
...
------------------------------------------------------------------------
if text then
local SoMaDrIn1_Msg = database:get(bot_id.."SoMaDrIn1:Add:Filter:Rp2"..text..result.chat_id_)   
if SoMaDrIn1_Msg then    
send(msg.chat_id_, msg.id_," ✞"..SoMaDrIn1_Msg)
